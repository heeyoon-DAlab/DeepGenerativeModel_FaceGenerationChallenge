#!/usr/bin/env python3
"""
make_grid.py — qualitative comparison figure for the report.

Loads the first N generated images from each experiment's output folder,
tiles each into a square montage, and places the three montages side by side
with titles. Same seeds across experiments, so the comparison is fair.

Usage (run after the three submissions have been generated):
  python make_grid.py --outputs outputs --out figures/comparison_grid.png --n 16
"""
